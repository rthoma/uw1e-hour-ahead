...
table Max_bound(d,t)
$ondelim
$include C:\BPA_project\Test_connect_HA_ok\Data\Maximum_availability_bounds.csv
$offdelim
;

table Min_bound(d,t)
$ondelim
$include C:\BPA_project\Test_connect_HA_ok\Data\Minimum_availability_bounds.csv
$offdelim
;

Max_bound(d,t)=Max_bound(d,t)/s_base;
Min_bound(d,t)=Min_bound(d,t)/s_base;
...
extracted_min(t,d)$(t_ha(t))..
         p_ext_minus(t,d) =l= -Min_bound(d,t)
;

extracted_max(t,d)$(t_ha(t))..
         p_ext_plus(t,d) =l= Max_bound(d,t)
;
...
put (p_ext_plus.l(t,d)-p_ext_minus.l(t,d)):0:6,","
);
...
minimum_load_aux(t,s)$(t_ha(t) and (M_cong(t) eq 1) and (p_ext2(d,t) gt 0))= (demand(s,t) + p_ext2(d,t))*s_base+ eps;
minimum_load_aux(t,s)$(t_ha(t) and (M_cong(t) eq 1) and (p_ext2(d,t) lt 0))= (demand(s,t) + Min_bound(d,t))*s_base+ eps;
minimum_load_aux(t,s)$(t_ha(t) and (M_cong(t) eq 1) and (p_ext2(d,t) eq 0))= demand(s,t)*s_base+ eps;
minimum_load_aux(t,s)$(t_ha(t) and M_cong(t) eq 0)= demand(s,t)*s_base+ eps;
);

loop((s,d)$(storage_map(d) eq ord(s)),
maximum_load_aux(t,s)$(t_ha(t) and (M_cong(t) eq 1) and (p_ext2(d,t) gt 0))= (demand(s,t) + Max_bound(d,t)  )*s_base+ eps;
maximum_load_aux(t,s)$(t_ha(t) and (M_cong(t) eq 1) and (p_ext2(d,t) lt 0))= (demand(s,t)+ p_ext2(d,t) )*s_base + eps;
maximum_load_aux(t,s)$(t_ha(t) and (M_cong(t) eq 1) and (p_ext2(d,t) eq 0))= demand(s,t)*s_base+ eps;
maximum_load_aux(t,s)$(t_ha(t) and M_cong(t) eq 0)= demand(s,t)*s_base+ eps;
);
...
execute_unload "cr2_ha_day2_hour24.gdx" power_flow_out,mst, sst,M_cong_snpd_aux, time_elapsed, M_cong_aux, slack_out ;
