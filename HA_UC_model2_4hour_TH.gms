...
execute_unload "uc_ha_day2_hour24_constrained_relieved.gdx" slack_solar_out_total,slack_wind_out_total,slack_fixed_out_total,power_output_out,slack_solar_out,slack_wind_out,slack_fixed_out,power_flow_out,mst, sst,total_cost,M_cong_snpd_aux, generation_cost, time_elapsed, M_cong_aux,flow_cong_output ;
