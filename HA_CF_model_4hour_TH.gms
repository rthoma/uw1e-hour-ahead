...
** The objective function comprises the commitment statuses which can be
** modified in this stage and all deviations from the power output of
** conventional generators, solar spillage, wind spillage, and fixed spillage.
** Also we incorporate the charging and discharging quantities.
...
** Relation between start-up and shudown variables in order to avoid
...
** Definition of the power output as the summation of the power output
** of each of the blocks
gen_sum(t, i)$(t_ha(t))..
        gbis(t, i) + deltag_plus(t, i) - deltag_minus(t, i) =e=
                sum(b, glin_bis(t, i, b) + deltag_lin_plus(t, i, b)
                                         - deltag_lin_minus(t, i, b));

** Minimum bound for the power output of conventional thermal units
gen_min(t, i)$(t_ha(t))..
        gbis(t, i) + deltag_plus(t, i) - deltag_minus(t, i) =g=
                g_min(i) * v(t, i);

** Maximum bounds for the power output of each of the blocks of the
** conventional thermal units
block_output(t, i, b)$(t_ha(t))..
        glin_bis(t, i, b) + deltag_lin_plus(t, i, b)
...
** Power flow of each line in terms of the voltage phase angles
